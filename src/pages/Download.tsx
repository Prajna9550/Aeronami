  ...
  return (
    <Layout>
      <div className="container mx-auto px-6 py-8 max-w-6xl">
        <div className="mb-8">
          <h2 className="text-3xl font-bold mb-2">Download Sensor Data</h2>
          <p className="text-muted-foreground">
            Export historical data in CSV format for analysis and machine learning
          </p>
        </div>
